...
public class CustomAndroidDriver extends AndroidDriver implements WebElement {
    public CustomAndroidDriver(HttpCommandExecutor executor,
    ...
    public CustomAndroidDriver(URL remoteAddress,
                               HttpClient.Factory httpClientFactory,
                               Capabilities desiredCapabilities) {
        super(remoteAddress, httpClientFactory, desiredCapabilities);
    }

    public CustomAndroidDriver(AppiumDriverLocalService service,
                               Capabilities desiredCapabilities) {
    ...
    public CustomAndroidDriver(AppiumServiceBuilder builder,
                               Capabilities desiredCapabilities) {
    ...
    public CustomAndroidDriver(HttpClient.Factory httpClientFactory,
                               Capabilities desiredCapabilities) {
        super(httpClientFactory, desiredCapabilities);
    }

    public CustomAndroidDriver(Capabilities desiredCapabilities) {
